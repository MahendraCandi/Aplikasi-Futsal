...
public class PopAlat extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(baris==-1){
            ...
            FP.kdAlat=tableAlat.getValueAt(baris, 0).toString();
            FP.pilihAlat();
            this.dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PopAlat.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
